...
const notifications: INotification[] = [
  {
    message: t('notifications.messages.pendingRequests'),
  ...
  {
    message: t('notifications.messages.newReports'),
    icon: 'calendar_today',
    id: 2,
    separator: true,
  ...
  {
    message: t('notifications.messages.trialExpired'),
    icon: 'error_outline',
    id: 3,
    separator: true,
  ...
  {
    message: t('notifications.messages.timezoneIncorrect'),
    icon: 'schedule',
    id: 4,
    updateTimestamp: makeDateFromNow(-2 * 7 * 24 * 60 * 60 * 1000),
  },
  {
    message: t('notifications.messages.newTeamMembers'),
    icon: 'group_add',
    id: 5,
    separator: false,
    updateTimestamp: makeDateFromNow(-3 * 60 * 1000),
  ...
  {
    message: t('notifications.messages.budgetExceeded'),
    icon: 'trending_up',
    id: 6,
    separator: true,
  ...
  {
    message: t('notifications.messages.tasksApproachingDeadlines'),
    icon: 'alarm',
    id: 7,
    separator: false,
  ...
  {
    message: t('notifications.messages.softwareUpdateAvailable'),
    icon: 'system_update',
    id: 8,
    separator: true,
