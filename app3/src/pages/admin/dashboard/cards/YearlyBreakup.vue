<template>
  <VaCard>
    <VaCardTitle class="pb-0!">
      <h1 class="card-title text-secondary font-bold uppercase">{{ t('pages.dashboard.yearlyBreakup') }}</h1>
    </VaCardTitle>
    <VaCardContent class="flex flex-row gap-1">
      <section class="w-1/2">
        ...
        <p class="text-xs text-success whitespace-nowrap">
          ...
          +2,5%
          <span class="text-secondary"> {{ t('pages.dashboard.lastYear') }}</span>
        </p>
        <div class="my-4 gap-2 flex flex-col">
          <div class="flex items-center">
            ...
            <span class="text-secondary">{{ t('pages.dashboard.earnings') }}</span>
          </div>
          <div class="flex items-center">
            <span class="inline-block w-2 h-2 mr-2" :style="{ backgroundColor: profitBackground }"></span>
            <span class="text-secondary">{{ t('pages.dashboard.profit') }}</span>
          </div>
        </div>
      </section>
